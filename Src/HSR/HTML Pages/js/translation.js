...
aLangKeys['de']['products']='Produkts';
aLangKeys['de']['contacts']='Kontakts';
...
aLangKeys['de']['aboutusp1']='Diese Website ist Teil einer Diplomarbeit mit dem Titel "Industrie 4.0: Eine mobile und modulare Lean Factory im Fokus mit MES und Wertschöpfungskette". Industrie 4.0, Die vierte industrielle Revolution ist eine kollektive Evolution aus den Trends der verarbeitenden Industrie. Die Industrie erfordert ein flexibleres und kostengünstigeres Fertigungssystem, das sich an alle Anforderungen anpassen kann. Industrie 4.0 nutzt Cyber-Physical-Systems (CPS) und Internet of Things (IoT) zur Automatisierung und Kommunikation zwischen Fertigungssystemen, Logistik etc.';
aLangKeys['de']['aboutusp2']='Die Master-Thesis soll Studenten demonstrieren und erziehen, um verschiedene Aspekte einer Industrie-4.0-Modell-Lean-Factory zu verstehen. Eine bewegliche und kompakte Fabrik kann in die Klasse oder an irgendeinen Ort zur Demonstration gebracht werden. Smart Factory Besteht aus einer IoT-Plattform, die Systeme innerhalb der Fabrik kommuniziert. Die These zeigt eine kleine Wertschöpfungskette eines Produkts mit der Bezeichnung Ring Holder und Manufacturing Execution System in einem Lean Factory-Konzept der Industrie 4.0.';
...
aLangKeys['de']['CYO']='Bestätige Ihre Bestellung';
